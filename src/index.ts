...
export interface MetallicCubeOptions {
...
export interface MetallicCubeInstance {
  scene: THREE.Scene;
...
export function createMetallicCube(options: MetallicCubeOptions = {}): MetallicCubeInstance {
...
const camera = new THREE.PerspectiveCamera(32, getWidth() / getHeight(), 0.1, 100);
...
if (container === document.body) {
  ...
  document.body.style.background = typeof backgroundColor === 'number' ? `#${backgroundColor.toString(16).padStart(6, '0')}` : String(backgroundColor);
}
